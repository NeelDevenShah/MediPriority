...
def make_video(general_information,vision_information):
    ...
    job_id = make_video_call_request(usename="c25laHM1NDgz", passwd="0I5Yx3w40", source_url="https://create-images-results.d-id.com/api_docs/assets/alice_getting_started_v3.png", input_text=text)
    print(job_id)
    print('-------------')
    time.sleep(20)
    video_url =extract_video_link(usename="c25laHM1NDgz", passwd="0I5Yx3w40", job_id=job_id)
